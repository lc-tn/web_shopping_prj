...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        NON_AUTHEN_RESOURCES.add("ChangePassController");
        NON_AUTHEN_RESOURCES.add("UploadController");
        NON_AUTHEN_RESOURCES.add("ViewCartController");
        NON_AUTHEN_RESOURCES.add("UpdateUserController");
        NON_AUTHEN_RESOURCES.add("DeleteUserController");
        NON_AUTHEN_RESOURCES.add("ViewOrderController");
        NON_AUTHEN_RESOURCES.add("EditStatusController");
        NON_AUTHEN_RESOURCES.add("AddController");
        ...
        NON_AUTHEN_RESOURCES.add("verifyMail.jsp");
        NON_AUTHEN_RESOURCES.add("changepassword.jsp");
